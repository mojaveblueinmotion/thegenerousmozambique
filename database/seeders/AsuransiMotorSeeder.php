...
class AsuransiMotorSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach ($data as $val) {
            $record          = AsuransiMotor::firstOrNew(['name' => $val['name']]);
        ...
        foreach ($dataPersentasi as $val) {
            $record  = AsuransiPersentasiMotor::firstOrNew([
        ...
        foreach ($dataRider as $val) {
            $record  = AsuransiRiderMotor::firstOrNew([
                    'asuransi_id' => $val['asuransi_id'],
