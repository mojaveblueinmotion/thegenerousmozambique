...
class CreateRefAsuransiProperti extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('ref_asuransi_properti_fitur', function (Blueprint $table) {
            $table->unsignedBigInteger('asuransi_id');
            $table->unsignedBigInteger('fitur_id');

            $table->foreign('asuransi_id')->references('id')->on('ref_asuransi_properti')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('ref_asuransi_properti_fitur');
        Schema::dropIfExists('ref_asuransi_properti');
    }
}
