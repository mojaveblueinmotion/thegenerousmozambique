...
class CreateRefAsuransiMotor extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('ref_asuransi_motor_fitur', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ref_asuransi_motor_fitur');
        Schema::dropIfExists('ref_asuransi_motor');
    }
}
