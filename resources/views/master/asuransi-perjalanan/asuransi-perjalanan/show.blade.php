...
<div class="form-group row">
	...
	<div class="col-sm-8 parent-group">
		<input type="text" disabled value="{{ $record->bank }}" name="bank" class="form-control" placeholder="{{ __('Bank') }}">
	</div>
</div>
<div class="form-group row">
	<label class="col-sm-4 col-form-label">{{ __('No Rekening') }}</label>
	<div class="col-sm-8 parent-group">
		<input type="text" disabled value="{{ $record->no_rekening }}" name="no_rekening" class="form-control" placeholder="{{ __('No Rekening') }}">
	</div>
</div>
@endsection
