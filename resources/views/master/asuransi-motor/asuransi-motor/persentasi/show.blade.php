...
<div class="form-group row">
    ...
    <div class="col-sm-9 parent-group">
        <input disabled type="text" name="kategori" value="{{ $persentasi->kategori }}" class="form-control" placeholder="{{ __('Kategori') }}">
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-md-6">
        <div class="form-group row">
            ...
            <div class="col-sm-6 parent-group">
                <input disabled type="number" value="{{ $persentasi->wilayah_satu_bawah }}" name="wilayah_satu_bawah" class="form-control" placeholder="{{ __('Wilayah 1 Batas Bawah') }}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-6 col-form-label">{{ __('Wilayah 2 Batas Bawah') }}</label>
            <div class="col-sm-6 parent-group">
                <input disabled type="number" value="{{ $persentasi->wilayah_dua_bawah }}" name="wilayah_dua_bawah" class="form-control" placeholder="{{ __('Wilayah 1 Batas Bawah') }}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-6 col-form-label">{{ __('Wilayah 3 Batas Bawah') }}</label>
            <div class="col-sm-6 parent-group">
                <input disabled type="number" value="{{ $persentasi->wilayah_tiga_bawah }}" name="wilayah_tiga_bawah" class="form-control" placeholder="{{ __('Wilayah 3 Batas Bawah') }}">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group row">
            ...
            <div class="col-sm-6 parent-group">
                <input disabled type="number" value="{{ $persentasi->wilayah_satu_atas }}" name="wilayah_satu_atas" class="form-control" placeholder="{{ __('Wilayah 1 Batas Atas') }}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-6 col-form-label">{{ __('Wilayah 2 Batas Atas') }}</label>
            <div class="col-sm-6 parent-group">
                <input disabled type="number" value="{{ $persentasi->wilayah_dua_atas }}" name="wilayah_dua_atas" class="form-control" placeholder="{{ __('Wilayah 2 Batas Atas') }}">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-6 col-form-label">{{ __('Wilayah 3 Batas Atas') }}</label>
            <div class="col-sm-6 parent-group">
                <input disabled type="number" value="{{ $persentasi->wilayah_tiga_atas }}" name="wilayah_tiga_atas" class="form-control" placeholder="{{ __('Wilayah 3 Batas Atas') }}">
            </div>
        </div>
    </div>
</div>
