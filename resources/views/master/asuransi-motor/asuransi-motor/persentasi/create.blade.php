...
@section('action', route($routes.'.persentasiStore', $record->id))
		...
		<div class="col-md-9 parent-group">
			<div class="input-group">
				<div class="parent-group input-group-prepend"><span
					...
					<input
					class="form-control base-plugin--inputmask_currency uang_pertanggungan_bawah" id="uang_pertanggungan_bawah" name="uang_pertanggungan_bawah"
		...
		<div class="col-md-9 parent-group">
			<div class="input-group">
				<div class="parent-group input-group-prepend"><span
					...
					<input
					class="form-control base-plugin--inputmask_currency uang_pertanggungan_atas" id="uang_pertanggungan_atas" name="uang_pertanggungan_atas"
		...
		<div class="col-md-6">
			<div class="form-group row">
				...
				<div class="col-sm-6 parent-group">
					<input type="number" name="wilayah_satu_bawah" class="form-control" placeholder="{{ __('Wilayah 1 Batas Bawah') }}">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-6 col-form-label">{{ __('Wilayah 2 Batas Bawah') }}</label>
				<div class="col-sm-6 parent-group">
					<input type="number" name="wilayah_dua_bawah" class="form-control" placeholder="{{ __('Wilayah 1 Batas Bawah') }}">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-6 col-form-label">{{ __('Wilayah 3 Batas Bawah') }}</label>
				<div class="col-sm-6 parent-group">
					<input type="number" name="wilayah_tiga_bawah" class="form-control" placeholder="{{ __('Wilayah 3 Batas Bawah') }}">
				</div>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group row">
				...
				<div class="col-sm-6 parent-group">
					<input type="number" name="wilayah_satu_atas" class="form-control" placeholder="{{ __('Wilayah 1 Batas Atas') }}">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-6 col-form-label">{{ __('Wilayah 2 Batas Atas') }}</label>
				<div class="col-sm-6 parent-group">
					<input type="number" name="wilayah_dua_atas" class="form-control" placeholder="{{ __('Wilayah 2 Batas Atas') }}">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-6 col-form-label">{{ __('Wilayah 3 Batas Atas') }}</label>
				<div class="col-sm-6 parent-group">
					<input type="number" name="wilayah_tiga_atas" class="form-control" placeholder="{{ __('Wilayah 3 Batas Atas') }}">
				</div>
			</div>
		</div>
	</div>
