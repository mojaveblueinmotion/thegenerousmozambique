...
@section('modal-body')
	...
	<div class="form-group row">
		...
		<div class="col-sm-8 parent-group">
			<input type="number" disabled value="{{ $record->zona_satu }}" name="zona_satu" class="form-control" placeholder="{{ __('Zona 1') }}">
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-4 col-form-label">{{ __('Zona 2') }}</label>
		<div class="col-sm-8 parent-group">
			<input type="number" disabled value="{{ $record->zona_dua }}" name="zona_dua" class="form-control" placeholder="{{ __('Zona 2') }}">
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-4 col-form-label">{{ __('Zona 3') }}</label>
		<div class="col-sm-8 parent-group">
			<input type="number" disabled value="{{ $record->zona_tiga }}" name="zona_tiga" class="form-control" placeholder="{{ __('Zona 3') }}">
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-4 col-form-label">{{ __('Zona 4') }}</label>
		<div class="col-sm-8 parent-group">
			<input type="number" disabled value="{{ $record->zona_empat }}" name="zona_empat" class="form-control" placeholder="{{ __('Zona 4') }}">
		</div>
	</div>
	<div class="form-group row">
		<label class="col-sm-4 col-form-label">{{ __('Zona 5') }}</label>
		<div class="col-sm-8 parent-group">
			<input type="number" disabled value="{{ $record->zona_lima }}" name="zona_lima" class="form-control" placeholder="{{ __('Zona 5') }}">
		</div>
	</div>
	<div class="form-group row">
