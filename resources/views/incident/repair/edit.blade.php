        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-8 parent-group">
                    ...
                    @foreach ($record->incident->files($module)->where('flag', 'repair')->get() as $file)
            ...
            <div class="form-group row">
                ...
                <div class="col-8 parent-group">
                    <select class="form-control base-plugin--select2-ajax"
                        data-url="{{ route('ajax.select-user', ['search' => 'technician', 'group_id' => $record->incident->identification->group_id]) }}"
