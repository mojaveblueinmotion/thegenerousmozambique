...
<body class="page">
    ...
    <main>
        <table style="border:none; width:100%;">
            <tr>
                <td style="border: none; font-weight: bold; vertical-align:top; width: 15%">Problem</td>
            ...
            <tr>
                ...
                <td rowspan="2" style="border: none; font-weight: bold; vertical-align:top; width: 15%">Linimasa</td>
                <td rowspan="2" style="border: none; text-align: center; vertical-align:top; width: 1%;">:</td>
                <td rowspan="2" style="border: none; vertical-align:top; width: 34%">
            ...
            <tr>
                ...
                <td style="border: none; vertical-align:top; width: 34%">
                    <ol class="mx-2 px-2">
                        @foreach ($record->refs as $problem)
                            <li>
                                {{ $problem->code }}
                            </li>
                        @endforeach
