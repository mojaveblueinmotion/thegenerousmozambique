                ...
                <div class="col-sm-12">
                    <table class="table table-bordered w-100">
                        ...
                        <tr>
                            ...
                            <td rowspan="2" style="font-weight: bold; width: 15%">Linimasa</td>
                            ...
                            <td rowspan="2" style="width: 34%">
                                ...
                                @if (isset($record->withdrawal->time))
                                    ...
                                    <br>
                                @endif
                                @if (isset($record->settlement->time))
                                    <b>Perbaikan:</b>
                                    {{ $record->settlement->time->diffForHumans($record->settlement->created_at) }}
                                    <br>
                                @endif
                    ...
                    <div class="col-12">
                        <table class="table table-bordered w-100">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; width: 1%;">:</td>
                                <td style="width: 34%">
                                    @forelse ($record->files('problem.identification')->where('flag', 'identification')->get() as $file)
                                        <div class="progress-container w-100" data-uid="{{ $file->id }}">
                                            <div class="alert alert-custom alert-light fade show py-2 px-4 mb-0 mt-2 success-uploaded"
                                                role="alert">
                                                <div class="alert-icon">
