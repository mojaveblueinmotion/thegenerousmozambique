...
@section('card-body')
    ...
    <div class="row">
            ...
            <div class="form-group row">
                ...
                <div class="col-8 parent-group">
                    <select class="form-control base-plugin--select2-ajax"
                        ...
                        data-placeholder="{{ __('Pilih Insiden Terkait') }}" id="incidentCtrl" multiple
                        name="incident_ids[]">
        ...
        <div class="col-6">
            <div class="form-group row">
                <label class="col-4 col-form-label">{{ __('Tanggal Problem') }}</label>
                <div class="col-8 parent-group">
                    <input class="form-control base-plugin--datepicker" data-options='@json([
                        'startDate' => '',
                        'endDate' => now()->format('d/m/Y'),
                    ])'
                        name="date" placeholder="{{ __('Tanggal Problem') }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-8 parent-group">
                    <select class="form-control base-plugin--select2-ajax"
                        ...
                        data-placeholder="{{ __('Pilih Problem Terkait') }}" id="problemCtrl" multiple name="ref_ids[]">
