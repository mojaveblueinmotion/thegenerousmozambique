		...
		<div class="container-fluid">
			<div class="card card-custom">
				<div class="card-header">
					<h3 class="card-title">Asuransi Perjalanan</h3>
		...
		<div class="container-fluid mt-5">
			<div class="row">
				<div class="col-md-12">
					<div class="card card-custom">
						<div class="card-header">
							<h3 class="card-title">Data Client & Asuransi</h3>
							<div class="card-toolbar">
							</div>
						</div>
						<div class="card-body">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card card-custom">
						...
						<div class="card-body">
							@include($views.'.detail.detail-perjalanan')
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-6">
					<div class="card card-custom">
						...
						<div class="card-body text-center">
							...
							'asuransi.polis-perjalanan')->first())
