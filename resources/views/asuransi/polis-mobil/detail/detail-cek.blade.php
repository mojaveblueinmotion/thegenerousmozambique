<div class="row">
	<div class="col-md-6">
		<div class="form-group row">
			<label class="col-md-4 col-form-label">{{ __('Merk Mobil') }}</label>
		...
		<div class="form-group row">
			<label class="col-md-4 col-form-label">{{ __('Seri Mobil') }}</label>
			<div class="col-md-8 parent-group">
		...
		<div class="form-group row">
			<label class="col-md-4 col-form-label">{{ __('Tahun Mobil') }}</label>
			<div class="col-md-8 parent-group">
		...
		<div class="form-group row">
			<label class="col-md-4 col-form-label">{{ __('Tipe Mobil') }}</label>
			<div class="col-md-8 parent-group">
				<select name="tipe_id" class="form-control base-plugin--select2-ajax tipe_id"
					data-url="{{ route('ajax.selectTipeMobil', ['search' => 'all']) }}"
					@if(request()->route()->getName() == $routes.'.detail.show' || request()->route()->getName() == $routes.'.approval') disabled @endif	
					placeholder="{{ __('Pilih Salah Satu') }}">
					<option value="">{{ __('Pilih Salah Satu') }}</option>
					@if (!empty($record->detailCek->tipe_id))
						<option value="{{ $record->detailCek->tipe_id }}" selected>{{ $record->detailCek->tipeMobil->name }}</option>
					@endif
				</select>
			</div>
		</div>
