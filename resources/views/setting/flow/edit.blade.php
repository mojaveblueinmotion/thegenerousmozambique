...
@section('card-title')
    Assign Hak Akses :
    <span class="ml-3 label label-lg label-inline label-danger text-nowrap text-bold">{{ \App\Support\Base::getModules($record->module) }}</span>
@endsection
                    ...
                    <tr data-key="{{ $loop->iteration }}">
                        ...
                        <td class="text-left parent-group">
                            <select name="flows[{{ $loop->iteration }}][role_id]"
                                ...
                                data-url="{{ route('ajax.select-role', ['search' => 'approver', 'perms' => $record->module]) }}"
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center">
                                ...
                                <button type="button" class="btn btn-danger btn-sm btn-icon remove-flow"><i
