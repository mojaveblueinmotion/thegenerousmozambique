                    ...
                    @if (empty($menu['section']))
                        ...
                        <thead>
                            <tr>
                                            ...
                                            <label
                                                ...
                                                @else
                                                    ...
                                                    <input type="checkbox" class="view check" name="check[]"
                                                        value="{{ $p->id }}"
                                                        @if ($record->hasPermissionTo($menu['perms'] . '.view')) checked @endif>
                                                    <span></span>
                                                @endif
                                            </label>
                                        </div>
                                        ...
                                        <div class="d-inline-block">
                                            <label
                                                ...
                                                <input type="checkbox" class="create check" name="check[]"
                                                    value="{{ $p->id }}"
                                                    @if ($record->hasPermissionTo($menu['perms'] . '.create')) checked @endif>
                                                    <span></span>
                                            </label>
                                        </div>
                                    @endif
                                ...
                                <th class="text-center ">
                                    @if (!empty($menu['submenu']) && !in_array($menu['name'], ['setting', 'master']) && !in_array($record->id, [1]))
                                        <button type="button" class="btn btn-light-primary font-weight-bold mr-2 check all"
                                            data-check="approve">
                ...
                @foreach ($menu['submenu'] as $child)
                    @if (empty($child['submenu']))
                        @php
                            ...
                            // $child['perms'] = $menu['perms'].'.'.$child['perms'];
                        @endphp
                        <tr>
                                ...
                                @if ($p = $perms->where('name', $child['perms'] . '.view')->first())
                                    <div class="d-inline-block">
                                        <label class="checkbox checkbox-lg checkbox-light-primary checkbox-sing">
                                            <input type="checkbox" class="view check" name="check[]"
                                                value="{{ $p->id }}"
                                                @if ($record->hasPermissionTo($child['perms'] . '.view')) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                @endif
                                ...
                                @if ($p = $perms->where('name', $child['perms'] . '.create')->first())
                                    <div class="d-inline-block">
                                        <label class="checkbox checkbox-lg checkbox-light-primary checkbox-sing">
                                            <input type="checkbox" class="create check" name="check[]"
                                                value="{{ $p->id }}"
                                                @if ($record->hasPermissionTo($child['perms'] . '.create')) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                @endif
                                ...
                                @if ($p = $perms->where('name', $child['perms'] . '.edit')->first())
                                    <div class="d-inline-block">
                                        <label class="checkbox checkbox-lg checkbox-light-primary checkbox-sing">
                                            <input type="checkbox" class="edit check" name="check[]"
                                                value="{{ $p->id }}"
                                                @if ($record->hasPermissionTo($child['perms'] . '.edit')) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                @endif
                                ...
                                @if ($p = $perms->where('name', $child['perms'] . '.delete')->first())
                                    <div class="d-inline-block">
                                        <label class="checkbox checkbox-lg checkbox-light-primary checkbox-sing">
                                            <input type="checkbox" class="delete check" name="check[]"
                                                value="{{ $p->id }}"
                                                @if ($record->hasPermissionTo($child['perms'] . '.delete')) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                @endif
                                    ...
                                    @if ($p = $perms->where('name', $child['perms'] . '.approve')->first())
                                        <div class="d-inline-block">
                                            <label class="checkbox checkbox-lg checkbox-light-primary checkbox-sing">
                                                <input type="checkbox" class="approve check" name="check[]"
                                                    value="{{ $p->id }}"
                                                    @if ($record->hasPermissionTo($child['perms'] . '.approve')) checked @endif>
                                                <span></span>
                                            </label>
                                        </div>
                                    @endif
