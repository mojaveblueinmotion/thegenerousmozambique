...
@section('page')
    <div class="d-flex flex-row">
        @include($views . '.includes.profile-aside', ['tab' => 'change-password'])
        ...
        <div class="flex-row-fluid ml-lg-8">
            <div class="card card-custom gutter-b">
                ...
                <form action="{{ route($routes . '.update-password') }}" method="post" autocomplete="off">
                    @csrf
                    @method('POST')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label
                                class="col-xl-3 col-lg-3 col-form-label text-right">{{ __('Konfirmasi Password Baru') }}</label>
                            <div class="col-lg-9 col-xl-6 parent-group">
                                <div class="input-group input-group-lg input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
