        ...
        <div class="col-6">
            <div class="form-group row">
                ...
                <div class="col-8 parent-group">
                    ...
                    @foreach ($record->change->files($module)->where('flag', 'settlement')->get() as $file)
            ...
            <div class="form-group row">
                ...
                <div class="col-8 parent-group">
                    <select class="form-control base-plugin--select2-ajax"
                        data-url="{{ route('ajax.select-user', ['search' => 'technician', 'group_id' => $record->change->analysis->group_id]) }}"
