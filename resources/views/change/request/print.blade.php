...
<body class="page">
    <header>
        <table style="border:none; width: 100%;">
            <tr>
                <td style="border: none; border:none;" width="150px">
                    <img src="{{ config('base.logo.print') }}" style="max-width: 150px; max-height: 60px">
                </td>
                <td style="border: none; border:none;  text-align: center; font-size: 14pt;" width="auto">
                    <b>{{ strtoupper(__('Change')) }}</b>
                    <div><b>{{ strtoupper(config('base.company.name')) }}</b></div>
                </td>
                <td style="border: none; border:none; text-align: right; font-size: 12px;" width="150px">
                    <b></b>
                </td>
            </tr>
        </table>
    ...
    <footer>
        <table width="100%" border="0" style="border: none;">
            <tr>
                <td style="border: none; width: 10%;border: none;" align="right"><span class="pagenum"></span></td>
            </tr>
        </table>
    </footer>
    <main>
        <table style="border:none; width:100%;">
            <tr>
                <td style="border: none; font-weight: bold; vertical-align:top; width: 15%">Change</td>
                ...
                <td style="border: none; font-weight: bold; vertical-align:top; width: 15%">Change Terkait</td>
                <td style="border: none; text-align: center; vertical-align:top; width: 1%;">:</td>
                <td style="border: none; vertical-align:top;width: 34%">
                    <ol class="mx-2 px-2">
            ...
            <tr>
                <td style="border: none; font-weight: bold; vertical-align:top; width: 15%">Problem Terkait</td>
                <td style="border: none; text-align: center; vertical-align:top; width: 1%;">:</td>
                <td style="border: none; vertical-align:top; width: 34%">
                    <ol class="mx-2 px-2">
