    ...
    public function notification()
    {
        ...
        $this->prepare(
            [
                ...
                'tableStruct' => [
                    'url' => route($this->routes . '.grid-notification'),
                    'datatable_1' => [
                        $this->makeColumn('name:num'),
    ...
    public function activity()
    {
        $this->prepare(
            [
                ...
                'tableStruct' => [
                    'url' => route($this->routes . '.grid-activity'),
                    'datatable_1' => [
                        $this->makeColumn('name:num'),
                        $this->makeColumn('name:module|label:Modul|className:text-left'),
                        $this->makeColumn('name:message|label:Deskripsi|className:text-left'),
    ...
    public function changePassword()
    {
        $this->prepare(
            [
                'title' => 'Ubah Password',
                'breadcrumb' => [
                    'Ubah Password'    => route($this->routes . '.change-password'),
                ],
            ]
        );
        return $this->render($this->views . '.change-password');
    }
