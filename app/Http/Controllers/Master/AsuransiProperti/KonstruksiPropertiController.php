            ...
            [
                'tableStruct' => [
                    'datatable_1' => [
                        ...
                        $this->makeColumn('name:zona_satu|label:Zona Satu|className:text-center'),
                        $this->makeColumn('name:zona_dua|label:Zona Dua|className:text-center'),
                        $this->makeColumn('name:zona_tiga|label:Zona Tiga|className:text-center'),
                        $this->makeColumn('name:zona_empat|label:Zona Empat|className:text-center'),
                        $this->makeColumn('name:zona_lima|label:Zona Lima|className:text-center'),
