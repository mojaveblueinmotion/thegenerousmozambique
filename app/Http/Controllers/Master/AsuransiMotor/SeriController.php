...
use App\Http\Requests\Master\AsuransiMotor\SeriRequest;

class SeriController extends Controller
{
    protected $module   = 'master.asuransi-motor.seri';
    protected $routes   = 'master.asuransi-motor.seri';
    protected $views    = 'master.asuransi-motor.seri';
        ...
        $this->prepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Seri Motor' => route($this->routes . '.index'),
                ]
            ]
        );
    }
