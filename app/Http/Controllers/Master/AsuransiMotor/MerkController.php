...
use App\Http\Requests\Master\AsuransiMotor\MerkRequest;

class MerkController extends Controller
{
    protected $module   = 'master.asuransi-motor.merk';
    protected $routes   = 'master.asuransi-motor.merk';
    protected $views    = 'master.asuransi-motor.merk';
        ...
        $this->prepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Merk Motor' => route($this->routes . '.index'),
                ]
            ]
        );
    }
