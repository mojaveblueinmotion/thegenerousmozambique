...
use App\Http\Requests\Master\Org\UnitRequest;
use App\Models\Master\Org\Struct;
use Illuminate\Http\Request;

class UnitBisnisController extends Controller
{
    protected $module   = 'master.org.unit-bisnis';
    protected $routes   = 'master.org.unit-bisnis';
    protected $views    = 'master.org.unit-bisnis';
        ...
        $this->prepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Unit Bisnis' => route($this->routes . '.index'),
                ]
            ]
        );
    }
    ...
    {
        $record = new Struct;
        return $record->handleStoreOrUpdate($request, 'unit-bisnis');
    }
    ...
    public function update(UnitRequest $request, Struct $record)
    {
        return $record->handleStoreOrUpdate($request, 'unit-bisnis');
    }
    ...
    public function importSave(Request $request)
    {
        ...
        $record = new Struct;
        return $record->handleImport($request, 'unit-bisnis');
    }
}
