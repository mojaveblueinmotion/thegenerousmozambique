...
use App\Http\Requests\Master\DatabaseMobil\TahunRequest;

class TahunController extends Controller
{
    protected $module   = 'master.database-mobil.tahun';
    protected $routes   = 'master.database-mobil.tahun';
    protected $views    = 'master.database-mobil.tahun';
        ...
        $this->prepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Tahun Mobil' => route($this->routes . '.index'),
                ]
            ]
        );
    }
