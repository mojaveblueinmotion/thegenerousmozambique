...
class PolisKontraktorItem extends Model
{
    protected $table = 'trans_polis_kontraktor_item';
    ...
    {
        return $this->belongsTo(PolisKontraktor::class, 'polis_id');
    }

    public function item()
    {
        return $this->belongsTo(ItemKontraktor::class, 'item_id');
    }
