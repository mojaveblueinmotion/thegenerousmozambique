...
namespace App\Models\Master\AsuransiKontraktor;

use App\Models\AsuransiKontraktor\PolisKontraktorItem;
use App\Models\Model;
use App\Models\Master\AsuransiMotor\Seri;

class ItemKontraktor extends Model
{
    protected $table = 'ref_item_kontraktor';
     ...
     ** RELATION
     *******************************/
    public function polisKontraktor(){
    ...
    {
        if($this->polisKontraktor()->exists()) return false;
        return true;
    }
}
