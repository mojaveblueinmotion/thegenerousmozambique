...
class PertanggunganTambahan extends Model
{
    protected $table = 'ref_pertanggungan_tambahan';
    ...
    {
        return $this->belongsToMany(RiderKendaraan::class, 'ref_pertanggungan_rider_group', 'pertanggungan_id', 'rider_id');
    }
    ...
    public function handleStoreOrUpdate($request)
    {
        ...
        try {
            ...
            $this->save();
            $this->riders()->sync($request->riders);
            $this->saveLogNotify();
