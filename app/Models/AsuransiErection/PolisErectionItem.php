...
class PolisErectionItem extends Model
{
    protected $table = 'trans_polis_erection_item';
    ...
    {
        return $this->belongsTo(PolisErection::class, 'polis_id');
    }

    public function item()
    {
        return $this->belongsTo(ItemErection::class, 'item_id');
    }
